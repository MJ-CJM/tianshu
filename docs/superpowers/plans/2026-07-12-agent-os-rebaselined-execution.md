...
> `superpowers:subagent-driven-development` to implement this plan one reviewed,
> committed slice at a time. Every behavior change follows TDD.
...
**Architecture:** Keep one integration owner and at most one implementation
slice active at a time. Shared contracts, migrations, public entry points, and
authority services are serialized; only read-only investigation and independent
review may run in parallel. Existing detailed phase plans remain technical
references, while this document owns sequencing, slice boundaries, gate states,
...
**Technical brief:** `.superpowers/sdd/g1.4b3-brief.md`
...
**Detailed brief:** `.superpowers/sdd/g1.5-brief.md`
...
**Detailed brief:** `.superpowers/sdd/g1.6-brief.md`
...
**Detailed reference:**
`docs/superpowers/plans/2026-07-11-phase-2-durable-governance-evidence.md`
...
**Detailed reference:**
`docs/superpowers/plans/2026-07-11-phase-3-desktop-web-productization.md`
...
- [ ] **S4.12:** Run real-stack Playwright, A11y, keyboard, zoom, visual,
      performance, and CI gates; record `automation_passed_pending_user_approval`.

## S5 - G4 Governed Evolution and Executor Neutrality

**Detailed reference:**
`docs/superpowers/plans/2026-07-11-phase-4-governed-evolution-executors.md`
...
**Detailed reference:**
`docs/superpowers/plans/2026-07-11-phase-5-open-source-launch.md`
...
2. After S3 freezes G2 gateway contracts, S4.1-S4.4 presentation/foundation work
   may overlap only with non-conflicting later G2 implementation; real pages
   wait for their named backend contracts.
