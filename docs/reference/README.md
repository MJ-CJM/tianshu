...
天枢借鉴融合的优秀开源项目，以及古风隐喻术语对照。参考分析解释能力来源，不决定
当前成熟度；当前支持边界见 [CURRENT-STATE](../CURRENT-STATE.md)。

| 文档 | 内容 |
|---|---|
| [reference-projects.md](reference-projects.md) | 借鉴融合分析：Claude Code / Hermes / NanoBot / DeepAgents 深度采纳，PicoClaw / ZeroClaw / Pi-Mono / OpenClaw / Kimi-CLI / CoPaw 等轻度参考；含按模块借鉴矩阵、`Ported from` 硬证据、以及天枢原创设计 |
| [original-designs.md](original-designs.md) | 原创设计专篇（借鉴篇的镜像）：天枢自己造了什么、相对借鉴项目新在哪；含真原创 / 原创封装 / 借鉴边界的诚实分级、机制类名、代码落点与设计文档链接 |
