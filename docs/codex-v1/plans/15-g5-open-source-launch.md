...
class ReleaseManifestV1(BaseModel):
    ...
    provenance_status: Literal["external_pending", "verified"]
...
uv run --frozen python scripts/build_release_manifest.py --artifacts artifacts/g5/release --provenance-status external_pending
