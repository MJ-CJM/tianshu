...
| 持久裁决、完整重启恢复、副作用账本与 Evidence Bundle | Planned / 规划 | Not available | 规划中的 durable governance boundary | — | v0.4.2 不保证 pending decision、任务和外部副作用在故障点的完整续接或去重 | [G2 roadmap](../superpowers/plans/2026-07-10-open-source-agent-os-master-roadmap.md#phase-2--durable-governance--evidence) | G2 |
