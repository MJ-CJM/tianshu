...
- 壳层视觉另与既有生产截图对照件 [`artifacts/qa-shell-side-by-side.png`](../artifacts/qa-shell-side-by-side.png) 同屏核对。
...
![1440 深色、侧栏展开的中枢总览](./01-control-center-dark-1440-expanded.png)

![1280 浅色、侧栏收起的中枢总览](./02-control-center-light-1280-collapsed.png)
...
![空理由提交后的校验状态](./03-decision-reason-required-light-1280.png)
...
![裁决完成后的锁定状态](./04-decision-approved-locked-light-1280.png)
...
![返回中枢再打开后仍保持锁定](./08-decision-navigation-persisted-light-1280.png)
...
![恢复初始状态后的解锁状态](./05-decision-reset-unlocked-light-1280.png)

- 点击“恢复初始状态”后，理由输入框和三个裁决动作重新启用。
- 重置后的页面没有残留上一份裁决结果或理由。

![驳回后的本地边界反馈](./09-decision-rejected-local-only-light-1280.png)

- 驳回明确显示“本地验收状态已更新，尚未写入真实治理时间线”，没有伪造持久化结果。

![1440 深色、侧栏展开的敕令详情](./10-decision-dark-1440-expanded.png)
...
![1440 深色、侧栏展开的演化中心](./11-evolution-dark-1440-expanded.png)

![演化中心总览与 18/50 强门禁](./06-evolution-overview-light-1280.png)

![继续观察后的本地边界反馈](./12-evolution-observe-local-only-light-1280.png)

![Canary 筛选后的单类证据](./07-evolution-canary-filter-light-1280.png)
