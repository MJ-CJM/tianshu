...
class OfficialSelector:
    ...
    _DEPARTMENT_KEYWORDS: dict[str, list[str]] = {
        "bingbu": [
            "execute", "run", "deploy", "build", "implement", "create",
            "执行", "运行", "部署", "构建", "实现", "创建", "开发", "修复", "编写", "脚本",
        ],
        "ducha": [
            "audit", "review", "check", "inspect", "verify", "validate",
            "审计", "审查", "核查", "检查", "校验", "验证", "复核",
        ],
        "hubu": [
            "cost", "budget", "finance", "expense", "token",
            "成本", "预算", "费用", "开销", "账单",
        ],
        "wenyuan": [
            "memory", "knowledge", "search", "recall", "document",
            "记忆", "知识", "检索", "查询", "回忆", "文档", "资料", "历史", "翻译", "总结",
            "介绍", "解释", "是什么", "为什么", "几位", "多少",
        ],
        "tongzheng": [
            "notify", "alert", "message", "report", "communicate",
            "通知", "提醒", "消息", "播报", "告知",
        ],
        "neige": [
            "plan", "strategy", "coordinate", "decide", "synthesize",
            "规划", "策略", "统筹", "协调", "决策",
        ],
    }
